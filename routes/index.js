...
res.render('index', { title: 'watercraft App', user : req.user });
});
router.get('/register', function(req, res) {
res.render('register', { title: 'watercraft App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'watercraft App Login', user : req.user });
  });
